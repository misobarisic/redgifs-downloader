...
async function main(creator, userMode, query, options) {
    const {dirname, eventEmitter, userMaker, searchMaker} = creator
    const {userCount, userEndpoint, searchCount, searchEndpoint} = creator.config
